...
- 飞书云盘负责长期保存 Journal、Notes、Reviews、Practices 和文章草稿；
...
- [weekly-review](skills/weekly-review/SKILL.md)：读取最近七天的 Journal 和 Notes，保存 Review、提出问题，并发现少量候选方向。
...
2. 在飞书云盘准备 `journal/`、`notes/`、`reviews/` 与 `practices/`，或允许 Bot 在第一次使用时创建。
